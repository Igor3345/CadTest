...
import { vacansion_card } from "./modules/vacansion_card";
import { modal_window } from "./modules/modal_window";
...
indiBlockController.add(video_player, ".js-video_player");
indiBlockController.add(vacansion_card, ".js-vacansion_card");
indiBlockController.add(modal_window, ".js-modal_window");
indiBlockController.add(modal_form, ".js-modal_form");
